...
#define BUTTON_ID_SELECT_MAP_0	(BUTTON_ID_SELECT_MAP + MAP_TEST_MAP)
	...
	void DynamicEntitiesAddForce(DynamicEntity* entities, GameTypes::entities_count_t entities_count, GravGen* grav_gens, GameTypes::map_elements_count_t grav_gens_count);
		...
		inline void CreateBulletLaserLoopBombKnife(Ship* ship);
		inline void CreateBulletLaserLoopBomb(Ship* ship);
		inline void CreateBulletLaserLoopKnife(Ship* ship);
		inline void CreateBulletLaserBombKnife(Ship* ship);
		inline void CreateBulletLoopBombKnife(Ship* ship);
		inline void CreateBulletLaserLoop(Ship* ship);
		inline void CreateBulletLaserBomb(Ship* ship);
		inline void CreateBulletLoopBomb(Ship* ship);
		inline void CreateBulletLaserKnife(Ship* ship);
		inline void CreateBulletLoopKnife(Ship* ship);
		inline void CreateBulletBombKnife(Ship* ship);
		inline void CreateBulletKnife(Ship* ship);
		inline void CreateBulletBomb(Ship* ship);
		inline void CreateBulletLoop(Ship* ship);
		inline void CreateBulletLaser(Ship* ship);
		inline void CreateBulletNoBonus(Ship* ship);
