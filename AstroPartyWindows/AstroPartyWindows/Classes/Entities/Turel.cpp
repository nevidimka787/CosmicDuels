...
DynamicParticle Turret::CreateShards(GameTypes::tic_t current_tic)
{
	return DynamicParticle(
		...
		DEFAULT_FORCE_RESISTANCE_AIR_COEFFICIENT,
...
Bullet Turret::Shoot()
{
	...
	return Bullet(new_bullet_position, new_bullet_velocity, AGGRESSIVE_ENTITY_HOST_ID, AGGRESSIVE_ENTITY_HOST_ID, false);
}
