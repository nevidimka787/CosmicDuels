...
Linker::Linker(Game* game_object, MenuFunctions* menu_functions_object, OpenGL* open_gl_object)
{
	...
	open_gl_object->game_p__flag_all_entities_initialisation = &game_object->flag_all_entities_initialisation;
	...
	open_gl_object->game_p__knives = &game_object->knives;
	open_gl_object->game_p__knives_array_mtx = &game_object->knives_array_mtx;
	open_gl_object->game_p__knives_count = &game_object->knives_count;
	...
	open_gl_object->game_p__stunning_timer = &game_object->stunning_timer;
