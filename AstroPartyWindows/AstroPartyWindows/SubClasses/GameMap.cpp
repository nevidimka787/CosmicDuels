...
#define MAP_TUREL_ON_CENTER__DOWN_RIGHT_RECTANGLE	5u
	...
	AddEntity(Turel(&new_position, 0.0f, 200u));
...
#define MAP_FORTRES__TUREL_ATTACK_DELAY		200
#define MAP_FORTRES__TUREL_ATTACK_PERIOD	500
#define MAP_FORTRES__TUREL_INACTIVE_PERIOD	410
#define MAP_FORTRES__TUREL_SHOOTS_COUNT		3
	...
	//AddEntity(Turel(diagonal.point + diagonal.vector, M_PI_2 - M_PI_4, MAP_FORTRES__TUREL_ATTACK_DELAY, MAP_FORTRES__TUREL_ATTACK_PERIOD, MAP_FORTRES__TUREL_INACTIVE_PERIOD, MAP_FORTRES__TUREL_SHOOTS_COUNT));
	AddEntity(Turel(diagonal.point + Vec2F(diagonal.vector.x - TUREL_DEFAULT_RADIUS, TUREL_DEFAULT_RADIUS), - M_PI_2, MAP_FORTRES__TUREL_ATTACK_DELAY, MAP_FORTRES__TUREL_ATTACK_PERIOD, MAP_FORTRES__TUREL_INACTIVE_PERIOD, MAP_FORTRES__TUREL_SHOOTS_COUNT));
	AddEntity(Turel(diagonal.point + Vec2F(TUREL_DEFAULT_RADIUS, diagonal.vector.y - TUREL_DEFAULT_RADIUS), M_PI, MAP_FORTRES__TUREL_ATTACK_DELAY, MAP_FORTRES__TUREL_ATTACK_PERIOD, MAP_FORTRES__TUREL_INACTIVE_PERIOD, MAP_FORTRES__TUREL_SHOOTS_COUNT));
	diagonal.Set(Vec2F(MAP_FORTRES__FRAME_POS) + Vec2F(MAP_FORTRES__WALL_SHIFT_BACK, -MAP_FORTRES__WALL_SHIFT_BACK), Vec2F(MAP_FORTRES__CORNER_SIZE, -MAP_FORTRES__CORNER_SIZE));
	rectangles[MAP_FORTRES__RECTANGLE_CORNER_DOWN_RIGHT].Set(&diagonal, MAP_PROPERTY_UNBREACABLE);
	//AddEntity(Turel(diagonal.point + diagonal.vector, - M_PI_4, MAP_FORTRES__TUREL_ATTACK_DELAY, MAP_FORTRES__TUREL_ATTACK_PERIOD, MAP_FORTRES__TUREL_INACTIVE_PERIOD, MAP_FORTRES__TUREL_SHOOTS_COUNT));
	AddEntity(Turel(diagonal.point + Vec2F(diagonal.vector.x - TUREL_DEFAULT_RADIUS, -TUREL_DEFAULT_RADIUS), M_PI_2, MAP_FORTRES__TUREL_ATTACK_DELAY, MAP_FORTRES__TUREL_ATTACK_PERIOD, MAP_FORTRES__TUREL_INACTIVE_PERIOD, MAP_FORTRES__TUREL_SHOOTS_COUNT));
	AddEntity(Turel(diagonal.point + Vec2F(TUREL_DEFAULT_RADIUS, diagonal.vector.y + TUREL_DEFAULT_RADIUS), M_PI, MAP_FORTRES__TUREL_ATTACK_DELAY, MAP_FORTRES__TUREL_ATTACK_PERIOD, MAP_FORTRES__TUREL_INACTIVE_PERIOD, MAP_FORTRES__TUREL_SHOOTS_COUNT));
	diagonal.Set(Vec2F(MAP_FORTRES__FRAME_POS) + Vec2F(-MAP_FORTRES__WALL_SHIFT_BACK, -MAP_FORTRES__WALL_SHIFT_BACK), Vec2F(-MAP_FORTRES__CORNER_SIZE, -MAP_FORTRES__CORNER_SIZE));
	rectangles[MAP_FORTRES__RECTANGLE_CORNER_DOWN_LEFT].Set(&diagonal, MAP_PROPERTY_UNBREACABLE);
	//AddEntity(Turel(diagonal.point + diagonal.vector, 2.0f * M_PI - M_PI_2 - M_PI_4, MAP_FORTRES__TUREL_ATTACK_DELAY, MAP_FORTRES__TUREL_ATTACK_PERIOD, MAP_FORTRES__TUREL_INACTIVE_PERIOD, MAP_FORTRES__TUREL_SHOOTS_COUNT));
	AddEntity(Turel(diagonal.point + Vec2F(diagonal.vector.x + TUREL_DEFAULT_RADIUS, -TUREL_DEFAULT_RADIUS), M_PI_2, MAP_FORTRES__TUREL_ATTACK_DELAY, MAP_FORTRES__TUREL_ATTACK_PERIOD, MAP_FORTRES__TUREL_INACTIVE_PERIOD, MAP_FORTRES__TUREL_SHOOTS_COUNT));
	AddEntity(Turel(diagonal.point + Vec2F(-TUREL_DEFAULT_RADIUS, diagonal.vector.y + TUREL_DEFAULT_RADIUS), 0.0f, MAP_FORTRES__TUREL_ATTACK_DELAY, MAP_FORTRES__TUREL_ATTACK_PERIOD, MAP_FORTRES__TUREL_INACTIVE_PERIOD, MAP_FORTRES__TUREL_SHOOTS_COUNT));
	diagonal.Set(Vec2F(MAP_FORTRES__FRAME_POS) + Vec2F(-MAP_FORTRES__WALL_SHIFT_BACK, MAP_FORTRES__WALL_SHIFT_BACK), Vec2F(-MAP_FORTRES__CORNER_SIZE, MAP_FORTRES__CORNER_SIZE));
	rectangles[MAP_FORTRES__RECTANGLE_CORNER_UP_LEFT].Set(&diagonal, MAP_PROPERTY_UNBREACABLE);
	//AddEntity(Turel(diagonal.point + diagonal.vector, M_PI - M_PI_4, MAP_FORTRES__TUREL_ATTACK_DELAY, MAP_FORTRES__TUREL_ATTACK_PERIOD, MAP_FORTRES__TUREL_INACTIVE_PERIOD, MAP_FORTRES__TUREL_SHOOTS_COUNT));
	AddEntity(Turel(diagonal.point + Vec2F(diagonal.vector.x + TUREL_DEFAULT_RADIUS, TUREL_DEFAULT_RADIUS), - M_PI_2, MAP_FORTRES__TUREL_ATTACK_DELAY, MAP_FORTRES__TUREL_ATTACK_PERIOD, MAP_FORTRES__TUREL_INACTIVE_PERIOD, MAP_FORTRES__TUREL_SHOOTS_COUNT));
	AddEntity(Turel(diagonal.point + Vec2F(-TUREL_DEFAULT_RADIUS, diagonal.vector.y - TUREL_DEFAULT_RADIUS), 0.0f, MAP_FORTRES__TUREL_ATTACK_DELAY, MAP_FORTRES__TUREL_ATTACK_PERIOD, MAP_FORTRES__TUREL_INACTIVE_PERIOD, MAP_FORTRES__TUREL_SHOOTS_COUNT));
