...
#define MAP_DECELERATION_AREA__RECTANGLES_COUNT		5
	...
	new_segment.Set(
		...
		Vec2F(MAP_DECELERATION_AREA__FRAME_SIZE, MAP_DECELERATION_AREA__FRAME_SIZE),
		true);
	rectangles[MAP_DECELERATION_AREA__FRAME_RECTANGEL_ID].Set(new_segment, MAP_PROPERTY_UNBREAKABLE | MAP_PROPERTY_COLLIDE_INSIDE);
	...
	new_segment.Set(
		...
		true);
	rectangles[MAP_DECELERATION_AREA__DOWN_RECTANGEL_ID].Set(new_segment, MAP_PROPERTY_UNBREAKABLE | MAP_PROPERTY_COLLIDE_OUTSIDE);
	...
	new_segment.Set(
		...
		true);
	rectangles[MAP_DECELERATION_AREA__RIGHT_RECTANGEL_ID].Set(new_segment, MAP_PROPERTY_UNBREAKABLE | MAP_PROPERTY_COLLIDE_OUTSIDE);

	new_segment.Set(
		Vec2F(MAP_DECELERATION_AREA__SIDE_SEGMENT_WIDTH, MAP_DECELERATION_AREA__OUT_SEGMENT_HIGH),
		Vec2F(-MAP_DECELERATION_AREA__SIDE_SEGMENT_WIDTH, MAP_DECELERATION_AREA__IN_SEGMENT_HIGH),
		true);
	rectangles[MAP_DECELERATION_AREA__UP_RECTANGEL_ID].Set(new_segment, MAP_PROPERTY_UNBREAKABLE | MAP_PROPERTY_COLLIDE_OUTSIDE);

	new_segment.Set(
		Vec2F(-MAP_DECELERATION_AREA__OUT_SEGMENT_HIGH, MAP_DECELERATION_AREA__SIDE_SEGMENT_WIDTH),
		Vec2F(-MAP_DECELERATION_AREA__IN_SEGMENT_HIGH, -MAP_DECELERATION_AREA__SIDE_SEGMENT_WIDTH),
		true);
	rectangles[MAP_DECELERATION_AREA__LEFT_RECTANGEL_ID].Set(new_segment, MAP_PROPERTY_UNBREAKABLE | MAP_PROPERTY_COLLIDE_OUTSIDE);
...
void Game::CreateMap6(std::vector<Vec2F>& ships_positions, std::vector<float>& ships_angles)
{
	...
	rectangles[MAP_DESTRUCTABLE__FRAME_RECTANGLE_ID].Set(diagonal, MAP_PROPERTY_UNBREAKABLE | MAP_PROPERTY_COLLIDE_INSIDE);
...
#define MAP_PORTAL__UP_LEFT_SHORT_RECTANGLE		11
	...
	Segment segment = Segment(
		...
		true);
	rectangles[MAP_PORTAL__UP_RIGTH_BIG_RECTANGLE].Set(segment, MAP_PROPERTY_UNBREAKABLE | MAP_PROPERTY_COLLIDE_INSIDE);
	...
	segment.Set(
		...
		true);
	rectangles[MAP_PORTAL__DOWN_RIGTH_BIG_RECTANGLE].Set(segment, MAP_PROPERTY_UNBREAKABLE | MAP_PROPERTY_COLLIDE_INSIDE);
...
void Game::CreateMap11(std::vector<Vec2F>& ships_positions, std::vector<float>& ships_angles)
{
	...
	cyrcles[0].Set(Vec2F(MAP_COLLAIDER__CENTER), MAP_COLLAIDER__EXTERNAL_CYRCLE_RADIUS, MAP_PROPERTY_UNBREAKABLE | MAP_PROPERTY_AGGRESSIVE);
	cyrcles[1].Set(Vec2F(MAP_COLLAIDER__CENTER), MAP_COLLAIDER__INTERNAL_CYRCLE_RADIUS, MAP_PROPERTY_UNBREAKABLE, false);

	map.Set(rectangles, cyrcles);

	AddEntity(DecelerationArea(Vec2F(MAP_COLLAIDER__CENTER), -DEFAULT_FORCE_RESISTANCE_AIR_COEFFICIENT * 1.05f, MAP_COLLAIDER__EXTERNAL_CYRCLE_RADIUS * 0.95f));
