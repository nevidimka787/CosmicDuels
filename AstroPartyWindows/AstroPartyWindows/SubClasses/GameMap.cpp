...
{
#define MAP_PORTAL__CENTER_POSITION			6.0f
...
#define MAP_PORTAL__PORTAL_POSITION_X		0.25f
#define MAP_PORTAL__PORTAL_POSITION_Y		1.75f
#define MAP_PORTAL__PORTAL_TP_POSITION_X	-0.25f
#define MAP_PORTAL__PORTAL_TP_POSITION_Y	1.75f
...
#define MAP_PORTAL__UP_LEFT_SHORT_RECTANGLE		11
	...
	AddEntity(Portal(
		Vec2F(MAP_PORTAL__PORTAL_POSITION_X + MAP_PORTAL__CENTER_POSITION, MAP_PORTAL__PORTAL_POSITION_Y + MAP_PORTAL__CENTER_POSITION),
		Vec2F(MAP_PORTAL__PORTAL_TP_POSITION_X + MAP_PORTAL__CENTER_POSITION, MAP_PORTAL__PORTAL_TP_POSITION_Y + MAP_PORTAL__CENTER_POSITION),
		PORTAL_DEFAULT_RADIUS,
		(float)M_PI));

	AddEntity(Portal(
		Vec2F(MAP_PORTAL__PORTAL_POSITION_Y + MAP_PORTAL__CENTER_POSITION, -MAP_PORTAL__PORTAL_POSITION_X + MAP_PORTAL__CENTER_POSITION),
		Vec2F(MAP_PORTAL__PORTAL_TP_POSITION_Y + MAP_PORTAL__CENTER_POSITION, -MAP_PORTAL__PORTAL_TP_POSITION_X + MAP_PORTAL__CENTER_POSITION),
		PORTAL_DEFAULT_RADIUS,
		(float)M_PI));
