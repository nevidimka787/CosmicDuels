...
#define PARTICLE_TYPE_NULL							((EngineTypes::Particle::type_t)0x00)
#define PARTICLE_TYPE_BACKGROUND					((EngineTypes::Particle::type_t)0x01)
#define PARTICLE_TYPE_EXAUST_ENGINE					((EngineTypes::Particle::type_t)0x02)
#define PARTICLE_TYPE_EXAUST_SHOOT					((EngineTypes::Particle::type_t)0x03)
#define PARTICLE_TYPE_EXAUST_BOMB_BOOM				((EngineTypes::Particle::type_t)0x04)
#define PARTICLE_TYPE_EXAUST_BUTNOUT				((EngineTypes::Particle::type_t)0x05)
#define PARTICLE_TYPE_SHARDS_ASTEROID				((EngineTypes::Particle::type_t)0x06)
#define PARTICLE_TYPE_SHARDS_ASTEROID_POWERED		((EngineTypes::Particle::type_t)0x07)
#define PARTICLE_TYPE_SHARDS_MAP_ELEMENT			((EngineTypes::Particle::type_t)0x08)
#define PARTICLE_TYPE_SHARDS_PILOT					((EngineTypes::Particle::type_t)0x09)
#define PARTICLE_TYPE_SHARDS_SHIP					((EngineTypes::Particle::type_t)0x0A)

#define PARTICLE_POSTPONE_BACKGROUND				0lu
#define PARTICLE_POSTPONE_EXAUST_BOMB_BOOM			0lu
#define PARTICLE_POSTPONE_EXAUST_BUTNOUT			0lu
...
#define PARTICLE_PERIOD_EXAUST_BUTNOUT				1lu
#define PARTICLE_PERIOD_SHARDS_ASTEROID				1lu
#define PARTICLE_PERIOD_SHARDS_ASTEROID_POWERED		1lu
#define PARTICLE_PERIOD_SHARDS_MAP_ELEMENT			1lu
#define PARTICLE_PERIOD_SHARDS_PILOT				1lu
