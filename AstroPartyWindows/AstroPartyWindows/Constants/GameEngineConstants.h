...
#define AGGRESSIVE_ENTITY_DEFAULT_ATTACK_DELAY			0
#define AGGRESSIVE_ENTITY_DEFAULT_ATTACK_PERIOD			300
#define AGGRESSIVE_ENTITY_DEFAULT_INACTIVE_PERIOD		100
#define AGGRESSIVE_ENTITY_DEFAULT_SHOOTS_COUNT			5
#define AGGRESSIVE_ENTITY_HOST_ID	PLAYERS_COUNT_T_MAX
...
#define ASTEROID_DEFAULT_VELOCITY	0.005f
...
#define BOMB_DEFAULT_ANGULAR_VELOCITY_INCREMENT	0.2f
...
#define BONUS_DEFAULT_FORCE_RESISTANCE_AIR_COEFFICIENT	0.02f


#define BULLET_IGNORE_MASK_FULL			0xFF
#define BULLET_IGNORE_NOTHING			0x00
#define BULLET_IGNORE_MUSTER			0x01
#define BULLET_IGNORE_KNIVES_OF_MASTER	0x02
...
#define BUTTON_CONTROLLER_SIZE			0.5f
...
#define CIRCLE_DEFAULT_RADIUS 0.1f
...
#define DEFAULT_FORCE_RESISTANCE_AIR_COEFFICIENT	0.01f


#define DYNAMIC_PARTICLE_PROPERTY_NULL							0x00

#define DYNAMIC_PARTICLE_PROPERTY_DESTROYED_BY_BOMB				0x01
#define DYNAMIC_PARTICLE_PROPERTY_DESTROYED_BY_LASER			0x02
#define DYNAMIC_PARTICLE_PROPERTY_DESTROYED_BY_MAP				0x04
#define DYNAMIC_PARTICLE_PROPERTY_FORCED_BY_GRAVITY_GENERATORS	0x08
#define DYNAMIC_PARTICLE_PROPERTY_FORCED_BY_MAP					0x10
#define DYNAMIC_PARTICLE_PROPERTY_FORCED_BY_SHIP				0x20
#define DYNAMIC_PARTICLE_PROPERTY_FORCED_BY_AIR_RESISTANCE		0x40
...
#define DYNAMIC_PARTICLE_PROPERTY_DESTROYED_BY_ALL (			\
	DYNAMIC_PARTICLE_PROPERTY_DESTROYED_BY_BOMB				|	\
	DYNAMIC_PARTICLE_PROPERTY_DESTROYED_BY_LASER			|	\
	DYNAMIC_PARTICLE_PROPERTY_DESTROYED_BY_MAP					\
	)
...
#define KNIFE_DEFAULT_RESISTANCE_AIR_COEFFICIENT	BULLET_DEFAULT_RESISTANCE_AIR_COEFFICIENT
...
#define LASER_PROPERTY_CAN_REFLECT	0x01
#define LASER_PROPERTY_CAN_MULTIPLICATE	0x02
#define LASER_PROPERTY_FREE_FROM_HOST	0x04
...
#define LOG_INCREMENT			0x01 //score will increment
#define LOG_DECREMENT			0x00 //score will decrement
...
#define MAP_PROPERTY_UNBREAKABLE		0x01 // element is unbreakable
#define MAP_PROPERTY_KILLER				0x02 // element can destroy players
#define MAP_PROPERTY_AGGRESSIVE			0x04 // element can destroy entities with out players
#define MAP_PROPERTY_CLOSED				0x08 // polygon is polygon, else polygon is broKen line
#define MAP_PROPERTY_COLLIDE_INSIDE		0x10 // rectangle checks collisions from inside of itself
#define MAP_PROPERTY_COLLIDE_OUTSIDE	0x20 // rectangle checks collisions from outside of itself

#define MAP_DEFAULT_PROPERTIES		(MAP_PROPERTY_UNBREAKABLE | MAP_PROPERTY_COLLIDE_INSIDE | MAP_PROPERTY_COLLIDE_OUTSIDE)


#define PARTICLE_TYPE_NULL							0u
#define PARTICLE_TYPE_BACKGROUND					1u
#define PARTICLE_TYPE_EXHAUST_ENGINE				2u
#define PARTICLE_TYPE_EXHAUST_BURNOUT				3u
#define PARTICLE_TYPE_EXHAUST_BOMB_BOOM				4u
#define PARTICLE_TYPE_EXHAUST_SHOOT					5u
...
#define PARTICLE_POSTPONE_EXHAUST_BOMB_BOOM			0lu
#define PARTICLE_POSTPONE_EXHAUST_BURNOUT			0lu
#define PARTICLE_POSTPONE_EXHAUST_ENGINE			0lu
#define PARTICLE_POSTPONE_EXHAUST_SHOOT				0lu
...
#define PARTICLE_PERIOD_EXHAUST_ENGINE				50lu
#define PARTICLE_PERIOD_EXHAUST_BURNOUT				50lu
#define PARTICLE_PERIOD_EXHAUST_BOMB_BOOM			1lu
#define PARTICLE_PERIOD_EXHAUST_SHOOT				10lu
...
#define PILOT_DEFAULT_FORCE_RESISTANCE_AIR_COEF 0.01f
...
#define SHIP_DEFAULT_RADIUS				0.05f
#define SHIP_DEFAULT_UNBREAKABLE_PERIOD	100
...
#define SHIP_DEFAULT_RELOADING_DELAY		200	//count of tics between last shooting and begin of reloading
#define SHIP_DEFAULT_RELOADING_PERIOD		50	//count of tics between reloading of two bullets (if it is zero then reloading is completed in one update)