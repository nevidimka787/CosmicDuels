...
#define GAME_RULE_PLAYERS_SPAWN_THIS_DIFFERENT_BONUS	(1 << 3)
#define GAME_RULE_TRIPLE_BONUSES						(1 << 4)
#define GAME_RULE_PLAYERS_SPAWN_THIS_SHIELD				(1 << 5)
#define GAME_RULE_PLAYERS_SPAWN_THIS_TRIPLE				(1 << 6)
#define GAME_RULE_TEAM_PLAY								(1 << 7)
#define GAME_RULE_FRENDLY_FIRE							(1 << 8)
...
#define BUTTON_ID_SET_SPAWN_THIS_DIFFERENT_BONUSES	13
#define BUTTON_ID_SET_TRIPLE_BONUSES				14
#define BUTTON_ID_SET_SPAWN_THIS_TRIPLE_BAFF		15
#define BUTTON_ID_SET_SPAWN_THIS_SHIELD_BAFF		16
#define BUTTON_ID_SET_ACTIVE_BALANCE				17
#define BUTTON_ID_SET_FRIEDLY_SHEEP_CAN_RESTORE		18
#define BUTTON_ID_SET_ACTIVE_FRIENDLY_FIRE			19
#define BUTTON_ID_SET_PILOT_CAN_RESPAWN				20
#define BUTTON_ID_SET_NEED_KILL_PILOT				21
#define BUTTON_ID_SET_KNIFES_CAN_DESTROY_BULLETS	22

#define BUTTON_ID_GO_TO_SELECT_MAP_MENU				30
#define BUTTON_ID_GO_TO_SELECT_BONUSES_MENU			31
#define BUTTON_ID_GO_TO_SELECT_START_BONUSES_MENU	32
#define BUTTON_ID_GO_TO_SELECT_OBJECTS_MENU			33
